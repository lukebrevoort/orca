...
const requiredTables = [
  ...
  "mobile_auth_requests", "mobile_sessions", "mobile_push_devices", "mobile_push_outbox", "mobile_push_sequence_counter", "mobile_push_email_sequence", "mobile_push_device_spaces",
];
